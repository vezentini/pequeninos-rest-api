...
import { deleteStudent, findSelectionStudentes, findStudents, upsertStudent } from '../services/students';
...
studentsRouter.post('/delete', async (req: Request, res: Response) => {
  const deleteResult = await deleteStudent(req.body)
